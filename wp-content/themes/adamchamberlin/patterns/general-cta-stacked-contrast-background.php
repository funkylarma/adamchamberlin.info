 ...
 * Slug: adamc/general-cta-stacked-contrast-background
...
<h2 class="has-text-align-center has-max-48-font-size" id="let-s-connect" style="margin-bottom:20px"><?php echo esc_html__( 'Let’s Connect', 'adamc' ); ?></h2>
<!-- /wp:heading -->
...
<div class="wp-block-button is-style-outline-base"><a class="wp-block-button__link wp-element-button"><?php echo esc_html__( 'Get in Touch', 'adamc' ); ?> →</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div>
<!-- /wp:group -->
