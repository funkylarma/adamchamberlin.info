...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link no-border-radius" href="#"><?php echo esc_html__( 'Get in Touch', 'adamc' ); ?> →</a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
