 ...
 * Slug: adamc/footer-three-columns-contrast-background
 * Categories: footer
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'adamc' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'adamc' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'adamc' ); ?></a></p>
<!-- /wp:paragraph -->
