 ...
 * Slug: adamc/general-hero-one-column
 * Categories: featured
 */
?>
...
<div class="wp-block-button"><a class="wp-block-button__link no-border-radius wp-element-button"><?php echo esc_html__( 'Get Started', 'adamc' ); ?></a></div>
<!-- /wp:button -->
