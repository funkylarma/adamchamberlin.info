 ...
 * Slug: adamc/general-portfolio-contrast-background
...
<h2 class="has-x-large-font-size" id="sample-heading"><?php echo esc_html__( 'Sample Heading', 'adamc' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'View Project', 'adamc' ); ?> →</a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
