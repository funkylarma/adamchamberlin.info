 ...
 * Slug: adamc/general-hero-three-columns
 * Categories: featured
 * Viewport Width: 1280
 */
?>
...
<h2 class="has-text-align-center has-x-large-font-size" id="image-heading-text-button-1"><?php echo esc_html__( 'Image, heading, text, button.', 'adamc' ); ?></h2>
<!-- /wp:heading -->
...
<figure class="wp-block-image size-full"><img src="<?php echo esc_url( get_theme_file_uri() ) . '/assets/images/sample-black_1200x1200.jpg'; ?>"  alt="<?php echo esc_attr__( 'Sample Image', 'adamc' ); ?>" class="wp-image-676"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link no-border-radius"><?php echo esc_html__( 'Learn More', 'adamc' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
