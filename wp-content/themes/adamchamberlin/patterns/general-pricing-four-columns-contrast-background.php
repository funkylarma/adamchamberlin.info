 ...
 * Slug: adamc/general-pricing-four-columns-contrast-background
 * Categories: featured
 * Viewport Width: 1280
 */
?>
...
<h2 class="has-text-align-center has-x-large-font-size" id="pricing-table"><?php echo esc_html__( 'Pricing Table', 'adamc' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center"><?php echo esc_html__( 'Create a four-column table, wide-width', 'adamc' ); ?> (1200px).</p>
<!-- /wp:paragraph -->
...
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Personal', 'adamc' ); ?> - $95</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
...
<p class="has-text-align-center has-small-font-size"><?php echo esc_html__( 'Feature Item', 'adamc' ); ?></p>
<!-- /wp:paragraph -->
...
<div class="wp-block-button"><a class="wp-block-button__link has-contrast-color has-base-background-color has-text-color has-background"><?php echo esc_html__( 'Sign Up Now', 'adamc' ); ?></a></div>
<!-- /wp:button -->
</div>
<!-- /wp:buttons -->
</div>
...
<div class="wp-block-group has-contrast-color has-base-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Professional', 'adamc' ); ?> - $295</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"base"} -->
...
<div class="wp-block-group has-contrast-color has-base-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Enterprise', 'adamc' ); ?> - $495</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"base"} -->
...
<div class="wp-block-group has-contrast-color has-base-background-color has-text-color has-background" style="padding-top:20px;padding-right:30px;padding-bottom:20px;padding-left:30px">
<!-- wp:heading {"textAlign":"center","level":4} -->
<h4 class="has-text-align-center" id="personal-95"><?php echo esc_html__( 'Ultimate', 'adamc' ); ?> - $995</h4>
<!-- /wp:heading -->
</div>
<!-- /wp:group -->
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|small","right":"var:preset|spacing|small","bottom":"var:preset|spacing|small","left":"var:preset|spacing|small"},"blockGap":"10px"},"border":{"width":"1px","style":"solid"}},"borderColor":"base"} -->
