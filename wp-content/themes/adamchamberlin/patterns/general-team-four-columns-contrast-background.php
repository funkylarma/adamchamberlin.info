 ...
 * Slug: adamc/general-team-four-columns-contrast-background
 * Categories: team
 * Viewport Width: 1280
 */
?>
...
<h2 class="has-text-align-center has-x-large-font-size" id="our-team"><?php echo esc_html__( 'Our Team', 'adamc' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
<p class="has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'The people who are ready to serve you.', 'adamc' ); ?></p>
<!-- /wp:paragraph -->
...
<h3 class="has-text-align-center has-medium-font-size" id="member-name-1"><?php echo esc_html__( 'Member Name', 'adamc' ); ?></h3>
<!-- /wp:heading -->
...
<p class="has-text-align-center"><a href="#"><?php echo esc_html__( 'View profile', 'adamc' ); ?></a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column -->
<!-- wp:column -->
<div class="wp-block-column"><!-- wp:image {"id":3488,"sizeSlug":"full","linkDestination":"none"} -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
<h3 class="has-text-align-center has-medium-font-size" id="member-name-2"><?php echo esc_html__( 'Member Name', 'adamc' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
<h3 class="has-text-align-center has-medium-font-size" id="member-name-3"><?php echo esc_html__( 'Member Name', 'adamc' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Lorem ipsum dolor sit amet, consectetur et adipiscing.</p>
<!-- /wp:paragraph -->
...
<!-- /wp:image -->
<!-- wp:heading {"textAlign":"center","level":3,"fontSize":"medium"} -->
<h3 class="has-text-align-center has-medium-font-size" id="member-name-4"><?php echo esc_html__( 'Member Name', 'adamc' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">Lorem ipsum dolor sit amet, consectetur et adipiscing.</p>
<!-- /wp:paragraph -->
