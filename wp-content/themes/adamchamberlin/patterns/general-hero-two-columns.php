 ...
 * Slug: adamc/general-hero-two-columns
 * Categories: featured
 * Viewport Width: 1280
 */
?>
...
<h2 class="has-x-large-font-size" id="text-on-left-image-on-right"><?php echo esc_html__( 'Text on left, media on right.', 'adamc' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph -->
...
<div class="wp-block-button is-style-fill"><a class="wp-block-button__link no-border-radius wp-element-button"><?php echo esc_html__( 'Get Started', 'adamc' ); ?></a></div>
<!-- /wp:button -->
<!-- wp:button {"style":{"border":{"radius":0}},"className":"is-style-outline"} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link no-border-radius wp-element-button"><?php echo esc_html__( 'Learn More', 'adamc' ); ?></a></div>
<!-- /wp:button --></div>
