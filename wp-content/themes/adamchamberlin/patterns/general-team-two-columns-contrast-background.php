 ...
 * Slug: adamc/general-team-two-columns-contrast-background
 * Categories: team
 * Viewport Width: 1280
 */
?>
...
<h2 class="has-x-large-font-size" id="our-team"><?php echo esc_html__( 'Our Team', 'adamc' ); ?></h2>
<!-- /wp:heading -->
<!-- wp:paragraph {"style":{"spacing":{"margin":{"bottom":"var:preset|spacing|medium"}}}} -->
<p style="margin-bottom:var(--wp--preset--spacing--medium)"><?php echo esc_html__( 'The people who are ready to serve you.', 'adamc' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<h3 class="has-medium-font-size" id="member-name"><?php echo esc_html__( 'Member Name', 'adamc' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectet adipiscing lectus. Vestibulum mi justo, luctus. <a href="#"><?php echo esc_html__( 'View profile', 'adamc' ); ?></a>.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
<!-- wp:columns -->
...
<!-- wp:column {"width":"75%"} -->
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:heading {"level":3,"fontSize":"medium"} -->
<h3 class="has-medium-font-size" id="member-name-1"><?php echo esc_html__( 'Member Name', 'adamc' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectet adipiscing lectus. Vestibulum mi justo, luctus. <a href="#"><?php echo esc_html__( 'View profile', 'adamc' ); ?></a>.</p>
<!-- /wp:paragraph --></div>
...
<!-- wp:column {"width":"75%"} -->
<div class="wp-block-column" style="flex-basis:75%"><!-- wp:heading {"level":3,"fontSize":"medium"} -->
<h3 class="has-medium-font-size" id="member-name-2"><?php echo esc_html__( 'Member Name', 'adamc' ); ?></h3>
<!-- /wp:heading -->
<!-- wp:paragraph -->
<p>Lorem ipsum dolor sit amet, consectet adipiscing lectus. Vestibulum mi justo, luctus. <a href="#"><?php echo esc_html__( 'View profile', 'adamc' ); ?></a>.</p>
<!-- /wp:paragraph --></div>
