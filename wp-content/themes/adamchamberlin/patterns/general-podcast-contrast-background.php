 ...
 * Slug: adamc/general-podcast-contrast-background
 * Categories: media
 * Viewport Width: 1280
 */
?>
...
<h2 class="has-x-large-font-size" id="sample-podcast-episode"><?php echo esc_html__( 'Sample Podcast Episode', 'adamc' ); ?></h2>
<!-- /wp:heading -->
