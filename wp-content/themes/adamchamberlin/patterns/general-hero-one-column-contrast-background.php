 ...
 * Slug: adamc/general-hero-one-column-contrast-background
 * Categories: featured
 */
?>
...
<h2 class="has-text-align-center has-x-large-font-size" id="image-heading-text-buttons" style="margin-top:var(--wp--preset--spacing--large)"><?php echo esc_html__( 'Image, heading, text, buttons.', 'adamc' ); ?></h2>
<!-- /wp:heading -->
