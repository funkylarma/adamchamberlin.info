...
export async function onRequestPost(context) {
  ...
  function processLike(like) {
    ...
    micropub.frontMatterContent.push('canonical: ' + like.url);
  ...
  function processCheckin(checkin) {
    ...
    micropub.frontMatterContent.push('latitude: ' + checkin[0].properties.latitude);
    micropub.frontMatterContent.push('longitude: ' + checkin[0].properties.longitude);
  ...
  function processPhoto(photos) {
    ...
    photos.forEach((photo) => {
      micropub.bodyContent.push('<img src="' + photo + '" alt="Checkin Photo" />');
      micropub.bodyContent.push('');
    });
  }
